...
document.addEventListener("DOMContentLoaded", () => {
  ...
  let currentActive =
    ...
    [...sections]
      .reverse()
      .findIndex((section) => window.scrollY >= (section.getBoundingClientRect().top + window.scrollY - 90)) -
    1;
  ...
  document.querySelector(".btn-top").addEventListener("click", () => {
    if (document.documentElement.clientWidth <= 900) {
      if (document.querySelector(".btn-menu").classList.contains("is-active")) {
        ...
        document
          .querySelectorAll("body,.btn-menu,.navbar-content")
          .forEach((elem) => {
            elem.classList.remove("is-active");
          });
      }
      ...
      if (
        document
          .querySelector(".btn-accessibility")
        ...
        document
          .querySelectorAll("body,.btn-accessibility,.navbar-accessibility")
          .forEach((elem) => {
            elem.classList.remove("is-active");
          });
      }
    ...
    let docTop = document.querySelector(".anchor-beginning");
    scrollIt(docTop);
  });
